...
public class MenuImportar extends javax.swing.JFrame {
    ...
    private void importarArquivosButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_importarArquivosButtonActionPerformed
        ...
        valorTextField.setText(caminhoArquivo);
    }
}// GEN-LAST:event_importarArquivosButtonActionPerformed

    // TextField para o valor do arquivo importado
    private void valorTextFieldActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        String caminhoArquivo = "C:\\Users\\joaop\\Downloads\\Coisas Aula\\CALCADOS RAMARIM LTDA.xml";
        String valorVPag = XMLReader.lerVPag(caminhoArquivo);
        valorTextField.setText(valorVPag);
    }        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuImportar.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
